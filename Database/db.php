...
$foods = [
  ...
  $accessories = [
    new Accessory(2134, 'Gipsy Trasportino', 'Croci', new Category('Gatti', '<i class="fa-solid fa-cat"></i>'), 8.67, true, 'https://arcaplanet.vtexassets.com/arquivos/ids/261414/GIPSY_AZZURRO-copia.jpg?v=1757207738', 'plastica', 'S'),
    new Accessory(98765, 'Tiragraffi', 'Badalona', new Category('Gatti', '<i class="fa-solid fa-cat"></i>'), 50, true, 'https://arcaplanet.vtexassets.com/arquivos/ids/223801/trixie-gatto-tiragraffi-badalona-beige.jpg?v=1757121092', 'Peluche', 'L' )
  ];
